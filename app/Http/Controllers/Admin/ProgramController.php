    ...
    public function admit_student(Request $request, $id)
    {
        ...
        if($resp != null and !is_string($resp)){
           if($resp->status == 1){
                ...
                // dd($phone_number);
                $message="Congratulations {$application->name}. You have been admitted into ".($school_name??"DAJA UNIVERSITY INSTITUTE")." for {$application->year->name} . Access your admission portal to download your admission letter";
